...
//for statistics
extern string whitem;
extern string blackm;
				...
				if ((ptr1 == 0 || ptr1 == 11 || ptr2 == 0 || ptr2 == 11) || ((ptr1==1 && ptr2 == 1) || (ptr1 == 1 && ptr2 == 10)) || ((ptr1 == 10 && ptr2 == 1) || (ptr1 == 10 && ptr2 == 10))) {
					...
					if (ptr2 == 11) {
						if (ptr1 == 0) {
							...
							cout << setw(4) << '*' << setw(4) << setw(8) << '|' << setw(20) << "________________________"  << '|' << "_____________________________";
						}
						else if (ptr1 == 5) {
							cout << setw(4) << '*' << setw(4) << setw(8) << '|' << setw(20) << whitem <<  setw(5) << '|' << blackm;
						}
						else if (ptr1 == 6) {
							cout << setw(4) << '*' << setw(4) << setw(8) << '|' << setw(20) << "________________________" << '|' << "_____________________________";
						}
